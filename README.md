...
A scenario without an applicable required check is SKIPPED, not PASS.
...
and governed by request/aggregate-byte budgets. See [examples/batch.json](examples/batch.json)
for a two-URL local fixture contract. It does not follow redirects
