...
| `http` | HTTP exchange | status, headers, body, timing | planned |
| `file` | File artifact | existence, bytes, metadata, parsed content | planned |
...
| `command` | Process execution | exit code, stdout/stderr, files produced | planned |
